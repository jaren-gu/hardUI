        ...
        <ul class="nav sidebar-menu">
            ...
            <li>
                ...
                <ul class="nav sub-nav">
                    <li>
                        <a id="bill" href="bill.php">
                            <span class="fa fa-arrows-h sidebar-icon"></span>
                            付费表单
                        </a>
                    </li>
                    <li>
                        <a id="invoice" href="invoice.php">
                            <span class="fa fa-arrows-h sidebar-icon"></span>
                            报表
                        </a>
                    </li>
                    ...
                    <li>
                        <a id="combo" href="combo.php">
                            <span class="fa fa-arrows-h sidebar-icon"></span>
                            VIP套餐
                        </a>
                    </li>
                    <li>
                        <a id="commontable1" href="commontable1.php">
                            <span class="fa fa-arrows-h sidebar-icon"></span>
                            通用列表1
                        </a>
                    </li>
                    <li id="commontable2">
                        <a href="commontable2.php">
                            <span class="fa fa-arrows-h sidebar-icon"></span>
                            通用列表2
                        </a>
                    </li>
                    <li>
                        <a id="flowone" href="flowone.php">
                            <span class="fa fa-arrows-h sidebar-icon"></span>
                            业务流程1
                        </a>
                    </li>
                    <li>
                        <a  id="flowtwo" href="flowtwo.php">
                            <span class="fa fa-arrows-h sidebar-icon"></span>
                            业务流程2
                        </a>
                    </li>
                    <li>
                        <a id="leadpage" href="leadpage.php">
                            <span class="fa fa-arrows-h sidebar-icon"></span>
                            标签打印
                        </a>
                    </li>
                    <li>
                        <a id="pandect" href="pandect.php">
                            <span class="fa fa-arrows-h sidebar-icon"></span>
                            账户总览
                        </a>
                    </li>
                    ...
                    <li>
                        <a id="remit" href="remit.php">
                            <span class="fa fa-arrows-h sidebar-icon"></span>
                            线下汇款
                        </a>
                    </li>
                    <li>
                        <a id="workOrder" href="workOrder.php">
                            <span class="fa fa-arrows-h sidebar-icon"></span>
                            财务类
                        </a>
                    </li>
                    <li>
                        <a id="deposit" href="deposit.php">
                            <span class="fa fa-arrows-h sidebar-icon"></span>
                            申请提现
                        </a>
                    </li>
                    <li>
                        <a id="recharge" href="recharge.php">
                            <span class="fa fa-arrows-h sidebar-icon"></span>
                            充值
                        </a>
                    </li>
            ...
            <li>
                <a id="profile-list" href="profile.php">
                    <span class="fa fa-cogs sidebar-icon"></span>
                    <span class="sidebar-title"> 个人中心类 </span>
                </a>
            </li>
            <li>
                <a id="search-list" href="search.php">
                    <span class="fa fa-cogs sidebar-icon"></span>
            ...
            <li>
                ...
                <ul class="nav sub-nav">
                    ...
                    <li>
                        <a id="forgotpw" href="forgotpw.php">
                            <span class="fa fa fa-arrows-h sidebar-icon"></span>
                            重置密码
                        </a>
                    </li>
