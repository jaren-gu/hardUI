...
(function($) {
    ...
    function _180(_181) {
        ...
        function _189(ids, _18a) {
            for (var i = 0; i < ids.length; i++) {
                ...
                if (_18b >= 0) { (_18a == "s" ? _97: _94)(_181, _18b, true);
                }
            }
        };
    ...
    $.fn.datagrid.parseOptions = function(_1f1) {
        var t = $(_1f1);
        return $.extend({},
        $.fn.panel.parseOptions(_1f1), $.parser.parseOptions(_1f1, ["url", "toolbar", "idField", "sortName", "sortOrder", "pagePosition", "resizeHandle", {
    ...
    $.fn.datagrid.parseData = function(_1f2) {
        ...
        //遍历表格当前每行数据：数据格式：{total:0,rows:[{列字段：数据，列字段：数据},{列字段：数据，列字段：数据}]}
